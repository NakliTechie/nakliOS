...
assert.match(anvil, /const executor = makeToolExecutor\(\{ shell: oshell, face: oface, mode:'code', infer: inferViaHost, subagentDepth: 1, scopes: ograph\.scopes \}\)/, 'a subagent executor is a raw makeToolExecutor over its overlay, projected by its grant');
