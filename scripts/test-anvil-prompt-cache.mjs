...
assert.match(anvil, /const tools = runToolset\(mode, \{ verify: !!verify, scopes: grant\.scopes, simple: simpleAsk \}\);/, 'the app sends the assembly\'s toolset and nothing else reaches it');
