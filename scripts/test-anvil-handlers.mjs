...
await test('NAF-04: the learn fork is reachable — tool registered, handled, and deferred not skipped', async () => {
  ...
  assert.match(src, /const tools = runToolset\(mode, \{ verify: !!verify, scopes: grant\.scopes, simple: simpleAsk \}\);/, 'and the app sends that toolset — importing the builder is not registering it');
